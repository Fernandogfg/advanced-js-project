...
export const msgSucesso = document.getElementById('msgSucesso')
export const msgErro = document.getElementById('msgErro')
export const dataEncurtamento = document.getElementById('dataEncurtamento')
